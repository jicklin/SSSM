...
function SelectUser(FUNC_ID,MODULE_ID,TO_ID,TO_NAME,MANAGE_FLAG,FORM_NAME,USE_UID,event)
{var w=453,h=350;URL="/module/user_select/?FUNC_ID="+FUNC_ID+"&MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&MANAGE_FLAG="+MANAGE_FLAG+"&FORM_NAME="+FORM_NAME+"&USE_UID="+USE_UID;var loc_y=loc_x=200;event=window.event||arguments.callee.caller.arguments[0];if(is_ie)
